    ...
    var pelanggan_dma = L.geoJson(null, {
      ...
      onEachFeature: function(feature, layer) {
        var popup_content = "<h3>" + feature.properties.nama_dma + "</h3>" +
          ...
          "<tr><th>Jumlah Pelanggan</th><td>" + feature.properties.jumlah_pelanggan.toLocaleString() +
          "</td></tr>" +
        ...
        layer.on({
          ...
          mouseover: function(e) { //Fungsi ketika mouse di atas obyek
            pelanggan_dma.bindTooltip(feature.properties.nama_dma + " (" + feature.properties.jumlah_pelanggan
              .toLocaleString() + ")", {
                sticky: true,
                direction: 'top'
              });
