...
<body>
  ...
  <script>
    ...
    map.getPane("pane_pipa").style.zIndex = 550;
    var pipa = L.tileLayer.wms("http://103.25.210.59:8080/geoserver/Tutorial/wms", {
      layers: 'Tutorial:pipa',
      format: 'image/png',
      version: '1.1.1',
      transparent: true,
      opacity: 1,
    ...
    map.on("click", GetFeatureInfo, pipa);
            ...
            vector = L.Proj.geoJson(data, {
              ...
              onEachFeature: function(feature, layer) {
                var infoPopup = "<table>" +
                  ...
                  "<tr><th>Diameter</th><td>" + feature.properties.diameter + " mm</td></tr>" +
                  "</table>";
                layer.on({
                  click: function(e) {
                    vector.bindPopup(infoPopup);
                  },
